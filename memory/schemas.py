...
def _current_session_id() -> str | None:
    """Return the current auth session id from env when present."""
...
AUDIT_OPTIONAL = {
    ...
    "session_id",
    "error",
    # B6 R9 — additive worker fanout fields. Existing rows without these
    # remain valid; new parallel-worker rows attach worker_id +
    # parent_session for post-hoc attribution.
    "worker_id",
    "parent_session",
}
