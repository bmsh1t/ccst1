...
## Summary
Validated `GET` authorization/business-logic evidence was recorded for `http://127.0.0.1:3001/api/Users`. generic:needs-evidence score=66 satisfied=2/3 missing=concrete target-owned impact
...
**Scanner Output:**
```
validation_runner:request_diff:users-enumeration-1
```

**Template/Check:** ``

**Finding Reference:**
- **Finding ID:** users-enumeration-1
- **Source artifact:** evidence/127.0.0.1:3001/validation/users-enumeration-1/20260912T175051084009Z-a8d893c0/summary.json
- **Source line:** 0
- **Confidence:** high
- **Finding summary:** generic:needs-evidence score=66 satisfied=2/3 missing=concrete target-owned impact
...
---
*Report generated: 2026-09-12 17:53:17*
