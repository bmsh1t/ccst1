...
## Summary
Validated `GET` authorization/business-logic evidence was recorded for `http://127.0.0.1:3001/api/BasketItems/1`. authz:needs-evidence score=25 satisfied=1/4 missing=actor / role / object boundary difference; observable response/data/action difference; target-owned business impact

## Affected URL
```
http://127.0.0.1:3001/api/BasketItems/1
```
...
**Scanner Output:**
```
validation_runner:request_diff:basketitem-bola-1
```

**Template/Check:** ``

**Finding Reference:**
- **Finding ID:** basketitem-bola-1
- **Source artifact:** evidence/127.0.0.1:3001/validation/basketitem-bola-1/20260912T152622238934Z-522c3c6c/summary.json
- **Source line:** 0
