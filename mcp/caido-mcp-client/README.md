...
Copy the `caido` entry from `mcp/caido-mcp-client/config.json` into your `~/.claude/settings.json` under `mcpServers`. If you have no other MCP servers configured:
