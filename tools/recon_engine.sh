...
if [ -n "${BBHUNT_RECON_SOFT_BUDGET_SECONDS:-}" ]; then
    RECON_SOFT_BUDGET_SECONDS="$BBHUNT_RECON_SOFT_BUDGET_SECONDS"
elif [ "$RECON_PROFILE" = "deep" ]; then
    RECON_SOFT_BUDGET_SECONDS=3600
else
