...
def save_targets(targets, output_file):
    ...
    output = {
        ...
        "targets": targets,
        "target_notes": [
            "Record the exact target set you want to work on",
            "Note sibling domains, IP ranges, or related hosts worth recon",
            "Capture pacing hints or environment quirks if they matter",
            "Keep any temporary exclusions local to the current run",
            "Bug bounty/VAPT notes should stay advisory only; do not carry them into CTF/lab targets",
            "Record asset-type hints you want to prioritize"
        ]
    }
...
def main():
    ...
    print("\n=============================================")
    print("  IMPORTANT: Target Notes")
    print("=============================================")
    print("  Before starting on any target:")
    print("  1. Record the exact target set")
    print("  2. Note important sibling hosts or app surfaces")
    print("  3. Capture pacing / environment hints if useful")
    print("  4. Keep temporary exclusions local to this run")
    print("  5. Prioritize the asset types you care about most")
    print("=============================================")
