...
class TestAuditLogWrite:
    ...
    def test_log_request_uses_env_session_id_when_omitted(self, tmp_hunt_dir, monkeypatch):
        path = tmp_hunt_dir / "audit.jsonl"
        log = AuditLog(path)
        monkeypatch.setenv("BBHUNT_SESSION_ID", "deadbeef1234")
        ...
        entries = log.read_all()
        assert entries[0]["session_id"] == "deadbeef1234"
