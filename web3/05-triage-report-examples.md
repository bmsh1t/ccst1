...
#### Q2: Is the impact concrete and economically meaningful?

Map the bug to a specific outcome the protocol or users actually lose.
...
If your bug does not map to a concrete loss or meaningful disruption: **KILL IT.**

---

#### Q3: Is the root cause in the contract or deployment context you are actually reviewing?
...
- If yes: valid
- If no: likely invalid (requires an unrealistic admin mistake)
