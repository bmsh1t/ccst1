...
**WARNINGS:**
- Verify findings manually before submitting — LLMs can hallucinate
- Match the runtime cost against the target value (some workflows cost real money)
- Keep the tool focused on precise hypotheses instead of noisy full-surface spam
