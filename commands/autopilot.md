...
For Queue activation fields, consume the bootstrap `activation_contract` projection generated by the Queue owner;
do not reconstruct a second claim schema from prose.
